...
namespace TowerLoadCals.BLL
{
    ...
    public class LoadDistributeLineCornerTower:LoadDistributeBase
    {
        ...
        public LoadDistributeLineCornerTower(FormulaParas para, StruLineParas[] lineParas, TowerTemplate template, string tablePath) : base(para, lineParas, template, tablePath)
        {
        ...
        protected void DistributeInLift(int i, int j)
        {
            ...
            else if (Math.Abs(zhs) > 100)
            {
                ...
                XX[i, j] = formula.ZZLX(angle, x1, y1, y2, zjiao, out string strX);
                YY[i, j] = formula.ZZLY(angle, x1, y1, y2, zjiao, out string strY);
                ZZ[i, j] = formula.ZZLZ2(z1, zg, fh, fhn, out string strZ);
        ...
        protected void DistributeInHuache(int i, int j)
        {
            ...
            else if ( Math.Abs(zhs) > 1000)
            {
                ...
                ZZ[i, j] = formula.ZZGZ(z2, z1, fh, fhn, out string strZ);
        ...
        protected void DistributeInTixian(int i, int j)
        {
            ...
            else if (Math.Abs(zhs) > 1000)
            {
                ...
                XX[i, j] = formula.ZZLX(angle, x1, y1, y2, zjiao, out string strX);
                YY[i, j] = formula.ZZLY(angle, x1, y1, y2, zjiao, out string strY);
                ZZ[i, j] = formula.ZZCZ(z1, LineParas.HoistingCoef, fhn, fh, out string strZ);
