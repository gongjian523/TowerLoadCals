...
namespace TowerLoadCals.BLL
{
    ...
    /// 耐脏塔的荷载分配
    /// </summary>
    public class LoadComposeTensionTower:LoadComposeBase
    {
        ...
        public LoadComposeTensionTower(StruCalseBaseParas para, StruLineParas[] lineParas, HangingPointSettingParas ratioParas, TowerTemplate template, string tablePath) 
        ...
        protected void DistributeInWindAndLowTemperature(int i, int j)
        {
            ...
            if (Math.Abs(zhs) > 0)
            {
                ...
                XLF[i, j - 1] = ((FormulaTensionTower)formula).ZNX(out string strXLF, angle, e3, c[1], c[2], Vcb, BL3);
                YLF[i, j - 1] = ((FormulaTensionTower)formula).ZNY(out string strYLF, angle, e3, c[1], c[2], Vcb);
                ZLF[i, j - 1] = ((FormulaTensionTower)formula).ZNZ(out string strZLF, c[3], Vcb);

                GenerateLineLoadString(j, strXLF, strYLF, strZLF, "线条前侧");
                ...
                XLB[i, j - 1] = ((FormulaTensionTower)formula).ZNX(out string strXLB, angle, e3, c[4], c[5], Vcb, BL3);
                YLB[i, j - 1] = ((FormulaTensionTower)formula).ZNY(out string strYLB, angle, e3, c[4], -c[5], Vcb);
                ZLB[i, j - 1] = ((FormulaTensionTower)formula).ZNZ(out string strZLB, c[6], Vcb);

                GenerateLineLoadString(j, strXLB, strYLB, strZLB, "线条后侧");
                ProcessString.Add(" ");
                ...
                if (tStringNum % 3 != 0 || tStringNum == 0)
                {
                    //0,1,2个跳线的时候 前后
                    //跳线串始终为一种计算方法
                    XTF[i, j - 1] = ((FormulaTensionTower)formula).ZNX(out string strXTF, angle, 0, c[7], 0, Vcb, BL3, tStringNum, HPSettingParas.BLTQ);
                    YTF[i, j - 1] = ((FormulaTensionTower)formula).ZNY(out string strYTF, angle, 0, c[7], 0, Vcb, tStringNum, HPSettingParas.BLTQ);
                    ZTF[i, j - 1] = ((FormulaTensionTower)formula).ZNZ(out string strZTF, c[8], Vcb, tStringNum, HPSettingParas.BLTQ);

                    if(tStringNum != 0)
                    {
                        GenerateLineLoadString(j, strXTF, strYTF, strZTF, "跳线前侧");
                    }

                    XTB[i, j - 1] = ((FormulaTensionTower)formula).ZNX(out string strXTB, angle, 0, c[7], 0, Vcb, BL3, tStringNum, HPSettingParas.BLTH);
                    YTB[i, j - 1] = ((FormulaTensionTower)formula).ZNY(out string strYTB, angle, 0, c[7], 0, Vcb, tStringNum, HPSettingParas.BLTH);
                    ZTB[i, j - 1] = ((FormulaTensionTower)formula).ZNZ(out string strZTB, c[8], Vcb, tStringNum, HPSettingParas.BLTH);

                    if (tStringNum != 0)
                    {
                        GenerateLineLoadString(j, strXTB, strYTB, strZTB, "跳线后侧");
                        ProcessString.Add(" ");
                    }
                }
                else if (tStringNum % 3 == 0 && tStringNum > 0)
                {
                    ...
                    XTC[i, j - 1] = ((FormulaTensionTower)formula).ZNX(out string strXTC, angle, 0, c[7], 0, Vcb, BL3, tStringNum, HPSettingParas.BLTZ);
                    YTC[i, j - 1] = ((FormulaTensionTower)formula).ZNY(out string strYTC, angle, 0, c[7], 0, Vcb, tStringNum, HPSettingParas.BLTZ);
                    ZTC[i, j - 1] = ((FormulaTensionTower)formula).ZNZ(out string strZTC, c[8], Vcb, tStringNum, HPSettingParas.BLTZ);

                    GenerateLineLoadString(j, strXTC, strYTC, strZTC, "跳线中部");
            ...
            else
            {
                ...
                {
                    XTF[i, j - 1] = ((FormulaTensionTower)formula).ZNX(out string strXTF, angle, 0, c[7], 0, Vcb, BL3, tStringNum, 0.33334f);
                    YTF[i, j - 1] = ((FormulaTensionTower)formula).ZNY(out string strYTF, angle, 0, c[7], 0, Vcb, tStringNum, 0.33334f);
                    ZTF[i, j - 1] = ((FormulaTensionTower)formula).ZNZ(out string strZTF, c[8], Vcb, tStringNum, 0.33334f);

                    GenerateLineLoadString(j, strXTF, strYTF, strZTF, "跳线前侧");

                    XTC[i, j - 1] = ((FormulaTensionTower)formula).ZNX(out string strXTC, angle, 0, c[7], 0, Vcb, BL3, tStringNum, 0.33334f);
                    YTC[i, j - 1] = ((FormulaTensionTower)formula).ZNY(out string strYTC, angle, 0, c[7], 0, Vcb, tStringNum, 0.33334f);
                    ZTC[i, j - 1] = ((FormulaTensionTower)formula).ZNZ(out string strZTC, c[8], Vcb, tStringNum, 0.33334f);

                    GenerateLineLoadString(j, strXTC, strYTC, strZTC, "跳线中部");

                    XTB[i, j - 1] = ((FormulaTensionTower)formula).ZNX(out string strXTB, angle, 0, c[7], 0, Vcb, BL3, tStringNum, 0.33334f);
                    YTB[i, j - 1] = ((FormulaTensionTower)formula).ZNY(out string strYTB, angle, 0, c[7], 0, Vcb, tStringNum, 0.33334f);
                    ZTB[i, j - 1] = ((FormulaTensionTower)formula).ZNZ(out string strZTB, c[8], Vcb, tStringNum, 0.33334f);
        ...
        protected void DistributeInIce(int i, int j)
        {
            ...
            if (Math.Abs(zhs) > 0)
            {
                ...
                XLF[i, j - 1] = ((FormulaTensionTower)formula).ZIBUYX(out string strXLF, angle, e3, c[1], c[2], e5, Vloadx, BL3);
                YLF[i, j - 1] = ((FormulaTensionTower)formula).ZIBUYY(out string strYLF, angle, e3, c[1], c[2], e5, Vloadx);
                ZLF[i, j - 1] = ((FormulaTensionTower)formula).ZIBUYZ(out string strZLF, c[9], c[3], e5, Vloadx, rg);
                ...
                XLB[i, j - 1] = ((FormulaTensionTower)formula).ZIBUYX(out string strXLB, angle, e3, c[4], c[5], e5, Vloadx, BL3);
                YLB[i, j - 1] = ((FormulaTensionTower)formula).ZIBUYY(out string strYLB, angle, e3, c[4], -c[5], e5, Vloadx);
                ZLB[i, j - 1] = ((FormulaTensionTower)formula).ZIBUYZ(out string strZLB, c[10], c[6], e5, Vloadx, rg);
                ...
                {
                    //跳线串始终为一种计算方法
                    XTF[i, j - 1] = ((FormulaTensionTower)formula).ZIBUYX(out string strXTF, angle, 0, c[7], 0, e5, Vloadx, BL3, tStringNum, HPSettingParas.BLTQ);
                    YTF[i, j - 1] = ((FormulaTensionTower)formula).ZIBUYY(out string strYTF, angle, 0, c[7], 0, e5, Vloadx, tStringNum, HPSettingParas.BLTQ);
                    ZTF[i, j - 1] = ((FormulaTensionTower)formula).ZIBUYZ(out string strZTF, c[11], c[8], e5, Vloadx, rg, tStringNum, HPSettingParas.BLTQ);
                    ...
                    XTB[i, j - 1] = ((FormulaTensionTower)formula).ZIBUYX(out string strXTB, angle, 0, c[7], 0, e5, Vloadx, BL3, tStringNum, HPSettingParas.BLTH);
                    YTB[i, j - 1] = ((FormulaTensionTower)formula).ZIBUYY(out string strYTB, angle, 0, c[7], 0, e5, Vloadx, tStringNum, HPSettingParas.BLTH);
                    ZTB[i, j - 1] = ((FormulaTensionTower)formula).ZIBUYZ(out string strZTB, c[11], c[8], e5, Vloadx, rg, tStringNum, HPSettingParas.BLTH);
                ...
                else
                {
                    ...
                    XTC[i, j - 1] = ((FormulaTensionTower)formula).ZIBUYX(out string strXTC, angle, 0, c[7], 0, e5, Vloadx, BL3, tStringNum, HPSettingParas.BLTZ);
                    YTC[i, j - 1] = ((FormulaTensionTower)formula).ZIBUYY(out string strYTC, angle, 0, c[7], 0, e5, Vloadx, tStringNum, HPSettingParas.BLTZ);
                    ZTC[i, j - 1] = ((FormulaTensionTower)formula).ZIBUYZ(out string strZTC, c[11], c[8], e5, Vloadx, rg, tStringNum, HPSettingParas.BLTZ);
            ...
            else if(zhs == 0)
            {
                ...
                GenerateLineLoadString(j, "0.00", "0.00", "0.00", "线条前侧");

                XLB[i, j - 1] = 0.00f;
                YLB[i, j - 1] = 0.00f;
                ZLB[i, j - 1] = 0.00f;

                GenerateLineLoadString(j, "0.00", "0.00", "0.00", "线条后侧");
                ProcessString.Add(" ");
                ...
                if (tStringNum % 3 != 0 || tStringNum == 0)
                {
                    ...
                    if (tStringNum != 0)
                    {
                        GenerateLineLoadString(j, "0.00", "0.00", "0.00", "跳线前侧");
                    }
                    ...
                    if (tStringNum != 0)
                    {
                        GenerateLineLoadString(j, "0.00", "0.00", "0.00", "跳线后侧");
                        ProcessString.Add(" ");
                    }
                }
                else
                {
                    ...
                    GenerateLineLoadString(j, "0.00", "0.00", "0.00", "跳线中部");
        ...
        protected void DistributeInLift(int i, int j)
        {
            ...
            else
            {
                ...
                XLF[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out string strXLF, angle, e3, c[1], c[2], BL3);
                YLF[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out string strYLF, angle, e3, c[1], c[2]);
                ZLF[i, j - 1] = ((FormulaTensionTower)formula).ZLZ(out string strZLF, c[3]);
                ...
                XLB[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out string strXLB, angle, e3, c[4], c[5], BL3);
                YLB[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out string strYLB, angle, e3, c[4], -c[5]);
                ZLB[i, j - 1] = ((FormulaTensionTower)formula).ZLZ(out string strZLB, c[6]);
            ...
            else if (zhs > 1000 && zhs < 2000 && zhs.ToString().Substring(0, 1) == "1")
            {
                ...
                if (tStringNum % 3 != 0 || tStringNum == 0)
                {
                    ...
                    XTF[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out string strXTF, angle, 0, c[7], 0, BL3, tStringNum, HPSettingParas.BLTQ);
                    YTF[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out string strYTF, angle, 0, c[7], 0, tStringNum, HPSettingParas.BLTQ);
                    ZTF[i, j - 1] = ((FormulaTensionTower)formula).ZLT2Z(out string strZTF, c[8], tStringNum, 0, HPSettingParas.BLTQ);
                    ...
                    XTB[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out string strXTB, angle, 0, c[7], 0, BL3, tStringNum, HPSettingParas.BLTH);
                    YTB[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out string strYTB, angle, 0, c[7], 0, tStringNum, HPSettingParas.BLTH);
                    ZTB[i, j - 1] = ((FormulaTensionTower)formula).ZLT2Z(out string strZTB, c[8], tStringNum, 0, HPSettingParas.BLTH);
                ...
                else if (tStringNum % 3 == 0 && tStringNum > 0)
                {
                    ...
                    XTC[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out string strXTC, angle, 0, c[7], 0, BL3, tStringNum, HPSettingParas.BLTZ);
                    YTC[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out string strYTC, angle, 0, c[7], 0, tStringNum, HPSettingParas.BLTZ);
                    ZTC[i, j - 1] = ((FormulaTensionTower)formula).ZLT2Z(out string strZTC, c[8], tStringNum, 0, HPSettingParas.BLTZ);
            ...
            else if (zhs > 2000 && zhs.ToString().Length == 4)
            {
                ...
                if (tStringNum % 3 == 0 && tStringNum > 0)
                {
                    ...
                    XTF[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out string strXTF, angle, 0, c[7], 0, BL3, tStringNum, HPSettingParas.BLTQ);
                    YTF[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out string strYTF, angle, 0, c[7], 0, tStringNum, HPSettingParas.BLTQ);
                    ZTF[i, j - 1] = ((FormulaTensionTower)formula).ZLT1Z(out string strZTF, c[8], tStringNum, fh_2, fhn, HPSettingParas.BLTQ);

                    GenerateLineLoadString(j, strXTF, strYTF, strZTF, "跳线前侧");

                    XTC[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out string strXTC, angle, 0, c[7], 0, BL3, tStringNum, HPSettingParas.BLTZ);
                    YTC[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out string strYTC, angle, 0, c[7], 0, tStringNum, HPSettingParas.BLTZ);
                    ZTC[i, j - 1] = ((FormulaTensionTower)formula).ZLT1Z(out string strZTC, c[8], tStringNum, fh_2, fhn, HPSettingParas.BLTZ);

                    GenerateLineLoadString(j, strXTC, strYTC, strZTC, "跳线中部");

                    XTB[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out string strXTB, angle, 0, c[7], 0, BL3, tStringNum, HPSettingParas.BLTH);
                    YTB[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out string strYTB, angle, 0, c[7], 0, tStringNum, HPSettingParas.BLTH);
                    ZTB[i, j - 1] = ((FormulaTensionTower)formula).ZLT1Z(out string strZTB, c[8], tStringNum, fh_2, fhn, HPSettingParas.BLTH);
            ...
            else if (zhs.ToString().Length == 5 && zhs.ToString().Substring(0, 1) == "1" && zhs.ToString().Substring(0, 3) != "100")
            {
                ...
                else
                {
                    switch (zhs.ToString().Substring(1, 1))
                    {
                        ...
                        case "1":
                            //已吊
                            XTF[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out string strXTF, angle, 0, c[7], 0, BL3, tStringNum);
                            YTF[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out string strYTF, angle, 0, c[7], 0, tStringNum);
                            ZTF[i, j - 1] = ((FormulaTensionTower)formula).ZLT2Z(out string strZTF, c[8], tStringNum, 0);
                            if (j > earthWireNum)
                            {
                                GenerateLineLoadString(j, strXTF, strYTF, strZTF, "跳线前侧");
                            }
                        ...
                        case "2":
                            //正吊
                            XTF[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out strXTF, angle, 0, c[7], 0, BL3, tStringNum);
                            YTF[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out strYTF, angle, 0, c[7], 0, tStringNum);
                            ZTF[i, j - 1] = ((FormulaTensionTower)formula).ZLT1Z(out strZTF, c[8], tStringNum, fh_2, fhn);
                            if (j > earthWireNum)
                            {
                                GenerateLineLoadString(j, strXTF, strYTF, strZTF, "跳线前侧");
                            }
                    ...
                    switch (zhs.ToString().Substring(2, 1))
                    {
                        ...
                        case "1":
                            //已吊
                            XTB[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out string strXTB, angle, 0, c[7], 0, BL3, tStringNum);
                            YTB[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out string strYTB, angle, 0, c[7], 0, tStringNum);
                            ZTB[i, j - 1] = ((FormulaTensionTower)formula).ZLT2Z(out string strZTB, c[8], tStringNum, 0);
                            if (j > earthWireNum)
                            {
                                GenerateLineLoadString(j, strXTB, strYTB, strZTB, "跳线后侧");
                                ProcessString.Add(" ");
                        ...
                        case "2":
                            //正吊
                            XTB[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out strXTB, angle, 0, c[7], 0, BL3, tStringNum);
                            YTB[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out strYTB, angle, 0, c[7], 0, tStringNum);
                            ZTB[i, j - 1] = ((FormulaTensionTower)formula).ZLT1Z(out strZTB, c[8], tStringNum, fh_2, fhn);
                            if (j > earthWireNum)
                            {
                                GenerateLineLoadString(j, strXTB, strYTB, strZTB, "跳线后侧");
                                ProcessString.Add(" ");
            ...
            else if (zhs.ToString().Length == 5 && zhs.ToString().Substring(0, 1) == "2" && zhs.ToString().Substring(0, 3) != "200")
            {
                ...
                else
                {
                    switch (zhs.ToString().Substring(1, 1))
                    {
                        ...
                        case "1":
                            //已吊
                            XTF[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out string strXTF, angle, 0, c[7], 0, BL3, tStringNum, HPSettingParas.BLDZTQ);
                            YTF[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out string strYTF, angle, 0, c[7], 0, tStringNum, HPSettingParas.BLDZTQ);
                            ZTF[i, j - 1] = ((FormulaTensionTower)formula).ZLT2Z(out string strZTF, c[8], tStringNum, 0, HPSettingParas.BLDZTQ);
                            if (j > earthWireNum)
                            {
                                GenerateLineLoadString(j, strXTF, strYTF, strZTF, "跳线前侧");
                            }
                        ...
                        case "2":
                            //正吊
                            XTF[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out strXTF, angle, 0, c[7], 0, BL3, tStringNum, HPSettingParas.BLDZTQ);
                            YTF[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out strYTF, angle, 0, c[7], 0, tStringNum, HPSettingParas.BLDZTQ);
                            ZTF[i, j - 1] = ((FormulaTensionTower)formula).ZLT1Z(out strZTF, c[8], tStringNum, fh_2, fhn, HPSettingParas.BLDZTQ, true);
                            if (j > earthWireNum)
                            {
                                GenerateLineLoadString(j, strXTF, strYTF, strZTF, "跳线前侧");
                            }
                    ...
                    switch (zhs.ToString().Substring(2, 1))
                    {
                        ...
                        case "1":
                            //已吊
                            XTB[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out string strXTB, angle, 0, c[7], 0, BL3, tStringNum, HPSettingParas.BLDZTH);
                            YTB[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out string strYTB, angle, 0, c[7], 0, tStringNum, HPSettingParas.BLDZTH);
                            ZTB[i, j - 1] = ((FormulaTensionTower)formula).ZLT2Z(out string strZTB, c[8], tStringNum * HPSettingParas.BLDZTH, 0);
                            if (j > earthWireNum)
                            {
                                GenerateLineLoadString(j, strXTB, strYTB, strZTB, "跳线后侧");
                                ProcessString.Add(" ");
                        ...
                        case "2":
                            //正吊
                            XTB[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out strXTB, angle, 0, c[7], 0, BL3, tStringNum, HPSettingParas.BLDZTH);
                            YTB[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out strYTB, angle, 0, c[7], 0, tStringNum, HPSettingParas.BLDZTH);
                            ZTB[i, j - 1] = ((FormulaTensionTower)formula).ZLT1Z(out strZTB, c[8], tStringNum, fh_2, fhn, HPSettingParas.BLDZTH, true);
                            if (j > earthWireNum)
                            {
                                GenerateLineLoadString(j, strXTB, strYTB, strZTB, "跳线后侧");
                                ProcessString.Add(" ");
                ...
                else
                {
                    ...
                    switch (zhs.ToString().Substring(2, 1))
                    {
                        ...
                        case "1":
                            //已吊
                            //   nt = 1    此处错误
                            XTC[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out string strXTC, angle, 0, c[7], 0, BL3, tStringNum);
                            YTC[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out string strYTC, angle, 0, c[7], 0, tStringNum);
                            ZTC[i, j - 1] = ((FormulaTensionTower)formula).ZLT2Z(out string strZTC, c[8], tStringNum, 0);
                            if (j > earthWireNum)
                            {
                                GenerateLineLoadString(j, strXTC, strYTC, strZTC, "跳线中部");
                            }
                        ...
                        case "2":
                            //正吊         
                            //  nt = 1    '此处错误
                            XTC[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out strXTC, angle, 0, c[7], 0, BL3, tStringNum);
                            YTC[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out strYTC, angle, 0, c[7], 0, tStringNum);
                            ZTC[i, j - 1] = ((FormulaTensionTower)formula).ZLT1Z(out strZTC, c[8], tStringNum, fh_2, fhn);
                            if (j > earthWireNum)
                            {
                                GenerateLineLoadString(j, strXTC, strYTC, strZTC, "跳线中部");
                            }
                ...
                else
                {
                    ...
                    switch (zhs.ToString().Substring(2, 1))
                    {
                        ...
                        case "1":
                            //已吊
                            //   nt = 1 
                            XTC[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out string strXTC, angle, 0, c[7], 0, BL3, tStringNum, HPSettingParas.BLDZTZ);
                            YTC[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out string strYTC, angle, 0, c[7], 0, tStringNum, HPSettingParas.BLDZTZ);
                            ZTC[i, j - 1] = ((FormulaTensionTower)formula).ZLT2Z(out string strZTC, c[8], tStringNum, 0, HPSettingParas.BLDZTZ);
                            if (j > earthWireNum)
                            {
                                GenerateLineLoadString(j, strXTC, strYTC, strZTC, "跳线中部");
                            }
                        ...
                        case "2":
                            //正吊         
                            //  nt = 1    
                            XTC[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out strXTC, angle, 0, c[7], 0, BL3, tStringNum, HPSettingParas.BLDZTZ);
                            YTC[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out strYTC, angle, 0, c[7], 0, tStringNum, HPSettingParas.BLDZTZ);
                            ZTC[i, j - 1] = ((FormulaTensionTower)formula).ZLT1Z(out strZTC, c[8], tStringNum, fh_2, fhn, HPSettingParas.BLDZTZ, true);
                            if (j > earthWireNum)
                            {
                                GenerateLineLoadString(j, strXTC, strYTC, strZTC, "跳线中部");
                            }
                    ...
                    switch (zhs.ToString().Substring(3, 1))
                    {
                        ...
                        case "1":
                            ...
                            XTB[i, j - 1] = ((FormulaTensionTower)formula).ZLX(out string strXTB, angle, 0, c[7], 0, BL3, tStringNum, HPSettingParas.BLDZTH);
                            YTB[i, j - 1] = ((FormulaTensionTower)formula).ZLY(out string strYTB, angle, 0, c[7], 0, tStringNum, HPSettingParas.BLDZTH);
                            ZTB[i, j - 1] = ((FormulaTensionTower)formula).ZLT2Z(out string strZTB, c[8], tStringNum, 0, HPSettingParas.BLDZTH);
                            if (j > earthWireNum)
                            {
                                GenerateLineLoadString(j, strXTB, strYTB, strZTB, "跳线后侧");
                                ProcessString.Add(" ");
        ...
        protected void DistributeInAnchor(int i, int j)
        {
            ...
            if(zhs > 1000)
            {
                ...
                XLF[i, j - 1] = ((FormulaTensionTower)formula).ZM1X(out string strXLF, angle, e3, c[1], c[2], BL3);
                YLF[i, j - 1] = ((FormulaTensionTower)formula).ZM1Y(out string strYLF, angle, e3, c[1], c[2]);
                ZLF[i, j - 1] = ((FormulaTensionTower)formula).ZM1Z(out string strZLF, c[3], fhn, fh_1);
            ...
            else if(zhs < 1000 && zhs >0)
            {
                ...
                XLF[i, j - 1] = ((FormulaTensionTower)formula).ZM2X(out string strXLF, angle, e3, c[1], c[2], BL3);
                YLF[i, j - 1] = ((FormulaTensionTower)formula).ZM2Y(out string strYLF, angle, e3, c[1], c[2]);
                ZLF[i, j - 1] = ((FormulaTensionTower)formula).ZM2Z(out string strZLF, c[3]);
        ...
        protected void DistributeInJ(int i, int j)
        {
            ...
            if (zhs > 1000)
            {
                ...
                XLF[i, j - 1] = ((FormulaTensionTower)formula).JX(out string strXLF, angle, c[1], Paras.DynamicCoef, LineParas.DrawingCoef, c[2], e3, BL3);
                YLF[i, j - 1] = ((FormulaTensionTower)formula).JY(out string strYLF, angle, c[1], Paras.DynamicCoef, LineParas.DrawingCoef, c[2], e3);
                ZLF[i, j - 1] = ((FormulaTensionTower)formula).JZ(out string strZLF, c[3], Paras.DynamicCoef, LineParas.DrawingCoef, c[2], fh_1, fhn);
            ...
            else if (zhs < 1000 && zhs > 0)
            {
                ...
                XLF[i, j - 1] = ((FormulaTensionTower)formula).JX(out string strXLF, angle, c[1], 1.0f, LineParas.DrawingCoef, c[2], e3, BL3);
                YLF[i, j - 1] = ((FormulaTensionTower)formula).JY(out string strYLF, angle, c[1], 1.0f, LineParas.DrawingCoef, c[2], e3);
                ZLF[i, j - 1] = ((FormulaTensionTower)formula).JZ(out string strZLF, c[3], 1.0f, LineParas.DrawingCoef, c[2], fh_1, fhn);
        ...
        protected void DistributeInMQ(int i, int j)
        {
            ...
            if (zhs > 1000)
            {
                ...
                XLF[i, j - 1] = ((FormulaTensionTower)formula).MQ1X(out string strXLF, angle, e3, c[1], c[2], BL3);
                YLF[i, j - 1] = ((FormulaTensionTower)formula).MQ1Y(out string strYLF, angle, e3, c[1], c[2]);
                ZLF[i, j - 1] = ((FormulaTensionTower)formula).MQ1Z(out string strZLF, c[3], c[2], fhn, fh_1);
                ...
                XLB[i, j - 1] = ((FormulaTensionTower)formula).MQ2X(out string strXLB, angle, e3, c[1], c[2], BL3);
                YLB[i, j - 1] = ((FormulaTensionTower)formula).MQ2Y(out string strYLB, angle, e3, c[1], c[2]);
                ZLB[i, j - 1] = ((FormulaTensionTower)formula).MQ2Z(out string strZLB, c[3]);
            ...
            else if (zhs > 100 && zhs < 1000)
            {
                ...
                XLF[i, j - 1] = ((FormulaTensionTower)formula).MQ3X(out string strXLF, angle, e3, c[1], c[2], BL3);
                YLF[i, j - 1] = ((FormulaTensionTower)formula).MQ3Y(out string strYLF, angle, e3, c[1], c[2]);
                ZLF[i, j - 1] = ((FormulaTensionTower)formula).MQ3Z(out string strZLF, c[3]);
                ...
                XLB[i, j - 1] = ((FormulaTensionTower)formula).MQ3X(out string strXLB, angle, e3, c[1], c[2], BL3);
                YLB[i, j - 1] = ((FormulaTensionTower)formula).MQ3Y(out string strYLB, angle, e3, c[1], -c[2]);
                ZLB[i, j - 1] = ((FormulaTensionTower)formula).MQ3Z(out string strZLB, c[3]);
            ...
            else if (zhs < 100 && zhs > 0)
            {
                ...
                XLF[i, j - 1] = ((FormulaTensionTower)formula).MQ4X(out string strXLF, e3, BL3);
                YLF[i, j - 1] = ((FormulaTensionTower)formula).MQ4Y(out string strYLF, e3);
                ZLF[i, j - 1] = ((FormulaTensionTower)formula).MQ4Z(out string strZLF);
        ...
        protected void DistributeInG(int i, int j)
        {
            ...
            if (wd.TensionAngleCode == "DX" || wd.TensionAngleCode == "DD")
            {
                ...
                else if (zhs > 1000)
                {
                    ...
                    XLF[i, j - 1] = ((FormulaTensionTower)formula).MQ3X(out string strXLF, angle, e3, c[1], c[2], BL3);
                    YLF[i, j - 1] = ((FormulaTensionTower)formula).MQ5Y(out string strYLF, LineParas.PulleyTensionDif);
                    ZLF[i, j - 1] = ((FormulaTensionTower)formula).MQ3Z(out string strZLF, c[3]);
                    ...
                    XLB[i, j - 1] = ((FormulaTensionTower)formula).MQ3X(out string strXLB, angle, e3, c[1], c[2], BL3);
                    YLB[i, j - 1] = ((FormulaTensionTower)formula).MQ5Y(out string strYLB, LineParas.PulleyTensionDif);
                    ZLB[i, j - 1] = ((FormulaTensionTower)formula).MQ3Z(out string strZLB, c[3]);
